...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ListingCheckerConfig.checker_runtime'
        db.alter_column(u'web_scraper_listingcheckerconfig', 'checker_runtime_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dynamic_scraper.SchedulerRuntime'], unique=True, null=True, on_delete=models.SET_NULL))
        # Adding unique constraint on 'ListingCheckerConfig', fields ['checker_runtime']
        db.create_unique(u'web_scraper_listingcheckerconfig', ['checker_runtime_id'])


        # Changing field 'ListingCheckerConfig.listing'
        db.alter_column(u'web_scraper_listingcheckerconfig', 'listing_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['listing.Listing'], unique=True, primary_key=True))
        # Adding unique constraint on 'ListingCheckerConfig', fields ['listing']
        db.create_unique(u'web_scraper_listingcheckerconfig', ['listing_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ListingCheckerConfig', fields ['listing']
        db.delete_unique(u'web_scraper_listingcheckerconfig', ['listing_id'])

        # Removing unique constraint on 'ListingCheckerConfig', fields ['checker_runtime']
        db.delete_unique(u'web_scraper_listingcheckerconfig', ['checker_runtime_id'])
        ...
        # Changing field 'ListingCheckerConfig.checker_runtime'
        db.alter_column(u'web_scraper_listingcheckerconfig', 'checker_runtime_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dynamic_scraper.SchedulerRuntime'], null=True, on_delete=models.SET_NULL))

        # Changing field 'ListingCheckerConfig.listing'
        db.alter_column(u'web_scraper_listingcheckerconfig', 'listing_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['listing.Listing']))
