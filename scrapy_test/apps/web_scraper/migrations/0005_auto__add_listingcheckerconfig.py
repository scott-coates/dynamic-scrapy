...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListingCheckerConfig'
        db.create_table(u'web_scraper_listingcheckerconfig', (
        ...
        db.send_create_signal(u'web_scraper', ['ListingCheckerConfig'])


    def backwards(self, orm):
        # Deleting model 'ListingCheckerConfig'
        db.delete_table(u'web_scraper_listingcheckerconfig')
