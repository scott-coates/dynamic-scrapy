...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListingSourceScraperConfig'
        db.create_table(u'web_scraper_listingsourcescraperconfig', (
    ...
    def backwards(self, orm):
        # Deleting model 'ListingSourceScraperConfig'
        db.delete_table(u'web_scraper_listingsourcescraperconfig')
