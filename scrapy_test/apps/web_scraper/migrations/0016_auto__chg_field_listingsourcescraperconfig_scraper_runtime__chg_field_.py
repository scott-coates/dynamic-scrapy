...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'web_scraper_listingsourcescraperconfig', 'scraper_runtime_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['dynamic_scraper.SchedulerRuntime'], unique=True))

        # Changing field 'ListingSourceScraperConfig.scraper'
        db.alter_column(u'web_scraper_listingsourcescraperconfig', 'scraper_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['dynamic_scraper.Scraper'], unique=True))

        # Changing field 'ListingCheckerConfig.checker_runtime'
        db.alter_column(u'web_scraper_listingcheckerconfig', 'checker_runtime_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['dynamic_scraper.SchedulerRuntime'], unique=True))
