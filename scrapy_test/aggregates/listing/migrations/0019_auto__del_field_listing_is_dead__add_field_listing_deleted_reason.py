...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Listing.deleted_reason'
        db.add_column(u'listing_listing', 'deleted_reason',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=2, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Listing.deleted_reason'
        db.delete_column(u'listing_listing', 'deleted_reason')
