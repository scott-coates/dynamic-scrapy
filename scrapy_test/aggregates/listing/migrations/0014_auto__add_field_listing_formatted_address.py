...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Listing.formatted_address'
        db.add_column(u'listing_listing', 'formatted_address',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=4096),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.formatted_address'
        db.delete_column(u'listing_listing', 'formatted_address')
