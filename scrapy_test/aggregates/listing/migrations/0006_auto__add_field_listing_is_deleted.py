...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Listing.is_deleted'
        db.add_column(u'listing_listing', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.is_deleted'
        db.delete_column(u'listing_listing', 'is_deleted')
