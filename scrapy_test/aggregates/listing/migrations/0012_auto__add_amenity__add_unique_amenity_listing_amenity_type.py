...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'listing_amenity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_available', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('listing', self.gf('django.db.models.fields.related.ForeignKey')(related_name='amenities', to=orm['listing.Listing'])),
            ('amenity_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='listing_instance', to=orm['amenity.Amenity'])),
        ))
        db.send_create_signal(u'listing', ['Amenity'])

        # Adding unique constraint on 'Amenity', fields ['listing', 'amenity_type']
        db.create_unique(u'listing_amenity', ['listing_id', 'amenity_type_id'])

        # Removing M2M table for field amenities on 'Listing'
        db.delete_table(db.shorten_name(u'listing_listing_amenities'))


    def backwards(self, orm):
        # Removing unique constraint on 'Amenity', fields ['listing', 'amenity_type']
        db.delete_unique(u'listing_amenity', ['listing_id', 'amenity_type_id'])

        # Deleting model 'Amenity'
        db.delete_table(u'listing_amenity')

        # Adding M2M table for field amenities on 'Listing'
        m2m_table_name = db.shorten_name(u'listing_listing_amenities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('listing', models.ForeignKey(orm[u'listing.listing'], null=False)),
            ('amenity', models.ForeignKey(orm[u'amenity.amenity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['listing_id', 'amenity_id'])
