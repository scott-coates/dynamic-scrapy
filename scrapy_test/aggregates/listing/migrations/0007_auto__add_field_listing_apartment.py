...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'listing_listing', 'apartment',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='listings', null=True, to=orm['apartment.Apartment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Listing.apartment'
        db.delete_column(u'listing_listing', 'apartment_id')
