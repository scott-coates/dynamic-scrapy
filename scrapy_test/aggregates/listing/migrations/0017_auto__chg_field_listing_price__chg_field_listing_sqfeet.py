...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'listing_listing', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Listing.sqfeet'
        db.alter_column(u'listing_listing', 'sqfeet', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Listing.price'
        db.alter_column(u'listing_listing', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'Listing.sqfeet'
        db.alter_column(u'listing_listing', 'sqfeet', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))
