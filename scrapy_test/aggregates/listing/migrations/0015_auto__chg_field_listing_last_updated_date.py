...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Listing.last_updated_date'
        db.alter_column(u'listing_listing', 'last_updated_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Listing.last_updated_date'
        db.alter_column(u'listing_listing', 'last_updated_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1973, 1, 1, 0, 0)))
