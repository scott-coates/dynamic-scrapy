...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Apartment.bedroom_count'
        db.alter_column(u'apartment_apartment', 'bedroom_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'Apartment.bedroom_count'
        db.alter_column(u'apartment_apartment', 'bedroom_count', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))
