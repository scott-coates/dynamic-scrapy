...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'apartment_apartment', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'Apartment.sqfeet'
        db.alter_column(u'apartment_apartment', 'sqfeet', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Apartment.price'
        db.alter_column(u'apartment_apartment', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'Apartment.sqfeet'
        db.alter_column(u'apartment_apartment', 'sqfeet', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))
