...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ListingSource'
        db.create_table(u'listing_source_listingsource', (
        ...
        db.send_create_signal(u'listing_source', ['ListingSource'])


    def backwards(self, orm):
        # Deleting model 'ListingSource'
        db.delete_table(u'listing_source_listingsource')
